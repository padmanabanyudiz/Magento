...
namespace Jawhara\Story\Helper;
...
class Data extends AbstractHelper
{
	...
	public function getImageUploader(){
		...
		$mediaDirectory = $this->fileSystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath('Jawhara/Story');
		// die("asd");
		$result = $uploaderFactory->save($mediaDirectory);
		$imgpath = 'Jawhara/Story/'.$result['file'];
		return $imgpath;
	}
